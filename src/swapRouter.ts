...
import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from 'swifydex-sdk-core'
...
import ISwapRouter from 'swifydex-v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
