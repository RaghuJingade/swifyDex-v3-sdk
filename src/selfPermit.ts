import { BigintIsh, Token } from 'swifydex-sdk-core'
import { Interface } from '@ethersproject/abi'
import ISelfPermit from 'swifydex-v3-periphery/artifacts/contracts/interfaces/ISelfPermit.sol/ISelfPermit.json'
