...
import { BigintIsh, Currency, CurrencyAmount, TradeType } from 'swifydex-sdk-core'
import { encodeRouteToPath, MethodParameters, toHex } from './utils'
import IQuoter from 'swifydex-v3-periphery/artifacts/contracts/lens/Quoter.sol/Quoter.json'
import IQuoterV2 from 'swifydex-swap-router-contracts/artifacts/contracts/lens/QuoterV2.sol/QuoterV2.json'
